  ...
  document.querySelector('html').setAttribute("data-theme",theme)
    ...
    return (
      ...
      <div className="">
      {
        ...
        <img referrerPolicy="no-referrer" data-tooltip-id="my-tooltip" data-tooltip-content={user?.displayName} className="w-10 h-10 md:w-14 md:h-14 rounded-full " src= {user?.photoURL} alt="" /><Tooltip id="my-tooltip"  className="z-10"/> <button className="bg-white rounded-md px-2 md:px-auto md:btn" onClick={signOutUser}>Log Out</button>
